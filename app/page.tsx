  ...
  return (
    <div className="min-h-screen text-foreground flex flex-col">
      ...
      <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-[826px] px-4">
        <div className="flex w-full flex-row items-center justify-between gap-3 rounded-full border border-white/20 px-3 py-2.5 backdrop-blur-lg bg-white/10 transition-colors duration-1000 md:gap-4 md:px-3.5 md:py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <GitHubLoginButton />
            <Link
              href="https://github.com/dev0jha/folix"
              target="_blank"
              rel="noreferrer"
      ...
      <main className="flex-1">
        {/* Hero */}
        <section className="relative mx-auto lg:h-[1127px] h-[800px] md:h-[1000px] min-h-screen w-full overflow-hidden">
          {/* Glassmorphism Background with Blue Gradient */}
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-cyan-500 to-indigo-600" />
          ...
          <div className="flex flex-wrap justify-between items-start gap-10 md:gap-[40px]">
            ...
            <div className="flex flex-wrap gap-10 md:gap-[40px]">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  <a
                    href="https://github.com/dev0jha/folix#readme"
                    target="_blank"
                    rel="noreferrer"
                    className="group"
                  >
                  ...
                  <a
                    href="https://github.com/dev0jha/folix/blob/main/CONTRIBUTING.md"
                    target="_blank"
                    rel="noreferrer"
                    className="group"
                  >
                  ...
                  <a
                    href="https://github.com/dev0jha/folix/blob/main/IMPLEMENTATION.md"
                    target="_blank"
                    rel="noreferrer"
                    className="group"
                  >
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <a
                    href="https://github.com/dev0jha/folix/blob/main/LICENSE"
                    target="_blank"
                    rel="noreferrer"
                    className="group"
                  >
                  ...
                  <a
                    href="https://github.com/dev0jha/folix/issues"
                    target="_blank"
                    rel="noreferrer"
                    className="group"
                  >
